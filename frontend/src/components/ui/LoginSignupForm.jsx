        ...
        <form>
          ...
          {!isLogin && (
            <div className="mb-4">
              ...
              <input type="text" className="w-full px-4 py-2 text-black rounded-lg" required />
            </div>
          )}
          ...
          <div className="mb-4">
            ...
            <input type="email" className="w-full px-4 py-2 text-black rounded-lg" required />
          </div>

          {/* Password */}
          <div className="mb-4">
            <label className="block text-white mb-1">Password</label>
            <input type="password" className="w-full px-4 py-2 text-black rounded-lg" required />
          </div>
          ...
          {!isLogin && (
            <div className="mb-4">
              ...
              <input type="tel" className="w-full px-4 py-2 text-black rounded-lg" required />
            </div>
          )}
          ...
          {!isLogin && (
            <div className="mb-4">
              ...
              <input type="date" className="w-full px-4 py-2 text-black rounded-lg" required />
            </div>
          )}
